...
export const DynamicArray: IArrayConstructor = class DynamicArray<T> extends AbstractArray<T> {

    constructor(
        capacity: number,
        equalsFunc: IEqualsFunction<T> = defaultEquals,
        incremental: number = capacity
    ) {
        super(capacity, equalsFunc, incremental);
    }
